...
void writeOutPlanes(std::string filePath, std::vector<PLANE> &planes, double scale)
{
  // write out bounding polygon result
  std::string fileEdgePoints = filePath + "planes.txt";
...
void writeOutLines(std::string filePath, std::vector<std::vector<cv::Point3d>> &lines, double scale)
{
  // write out bounding polygon result
  std::string fileEdgePoints = filePath + "lines.txt";
  FILE *fp2                  = fopen(fileEdgePoints.c_str(), "w");
...
int main()
{
  std::string fileData = "D://Facade//data.txt";
  std::string fileOut  = "D://Facade//data";
